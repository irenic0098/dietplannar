...
const translations = {
  en: {
    ...
    // Home / Landing
    heroTitle: "Transform Your Health with Smart Diet Planning",
    heroSubtitle: "Get personalized nutrition guides, calculate BMI, track water intake, generate recipes, and consult certified dieticians.",
  ...
  hi: {
    ...
    // Home / Landing
    heroTitle: "स्मार्ट डाइट प्लानिंग के साथ अपने स्वास्थ्य को बदलें",
    heroSubtitle: "व्यक्तिगत पोषण मार्गदर्शिका प्राप्त करें, बीएमआई की गणना करें, पानी के सेवन को ट्रैक करें, रेसिपी उत्पन्न करें, और प्रमाणित आहार विशेषज्ञों से परामर्श करें।",
